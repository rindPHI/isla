...
octal_conv_grammar = (
    octal_conv_grammar.set("<start>", ("<octal_digits>", "<decimal_digits>"))
    .set("<decimal_digits>", ("<decimal_digit><decimal_digits>", "<decimal_digit>"))
    .set("<decimal_digit>", srange(string.digits))
)
