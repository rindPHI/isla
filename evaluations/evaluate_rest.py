...
repair_link_defuse_len_numbering_no_redef = lambda timeout: RepairSolver(
    rest.REST_GRAMMAR,
    rest.DEF_LINK_TARGETS
    & rest.LENGTH_UNDERLINE
    & rest.LIST_NUMBERING_CONSECUTIVE
...
if __name__ == "__main__":
    ...
    generators = [
        ...
        repair_link_defuse_len_numbering_no_redef,
    ]
    ...
    jobnames = [
        ...
        "Def-Use + Len + List Numbering + No-Redef (RepairSolver)",
    ]
